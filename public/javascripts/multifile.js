...
function MultiSelector(list_target, max) {
  ...
  this.addListRow = function( element ){
    ...
    var new_row_button = document.createElement( 'a' );new_row_button.setAttribute('class', 'remove-file');new_row_button.title = 'Удалить этот файл';new_row_button.href = '#';new_row_button.innerHTML = 'Удалить';new_row.element = element;
